  ...
  return (
    <Link to={`/project/${project.slug}`}>
      <motion.div
        ...
        className="w-[calc(100vw-3rem)] sm:w-[400px] h-[500px] bg-zinc-900 border border-white/5 rounded-3xl p-8 flex flex-col justify-between group hover:border-white/20 transition-all duration-500 relative overflow-hidden shrink-0"
      >
...
function Home({ showIntro, setShowIntro }) {
  ...
  useEffect(() => {
    const checkScreen = () => {
      ...
      setIsDesktop(!isCoarse && window.innerWidth >= 1024);
    };
    checkScreen();
  ...
  const { scrollYProgress } = useScroll({ target: isDesktop ? targetRef : undefined });
  const x = useTransform(
    scrollYProgress,
    [0, 1],
    [0, -(scrollWidth - (typeof window !== 'undefined' ? window.innerWidth : 0))]
  );
  ...
  const scrollToSection = (id) => {
    ...
    if (isDesktop && containerRef.current && targetRef.current) {
    ...
    setMenuOpen(false); // Close menu if mobile menu is open
  };
  ...
  const sectionsContent = (
    <>
            ...
            {/* ── SECTION 1: HERO ── */}
            <section id="hero" className={isDesktop ? "w-screen max-w-full h-screen relative flex items-center shrink-0" : "w-full relative flex items-center min-h-screen py-32 px-6 lg:px-12 overflow-hidden"}>
              <Particles />
              <GridOverlay />

              <div className="absolute inset-0 bg-black pointer-events-none overflow-hidden">
                <div className="absolute inset-y-0 right-0 w-[60%] lg:w-[55%] hero-skew-bg hidden lg:block" style={{ backgroundColor: '#ffffff' }} />
              ...
              <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 items-center gap-12 relative z-10">
                <div className="space-y-8 lg:col-span-7">
                  ...
                  <div className="overflow-hidden">
                    <motion.h1
                      ...
                      className="text-4xl sm:text-6xl md:text-7xl lg:text-[5rem] xl:text-[6.5rem] font-bold leading-[0.85] tracking-tighter uppercase"
                    >
                      Guru<br />
                  ...
                  <motion.p
                    ...
                    className="text-xl md:text-2xl font-medium tracking-tight max-w-lg leading-relaxed text-white/85"
                  >
                    Fascinative Design & Simulation Enthusiast
                    <br />
                    <span className="text-sm opacity-50 mt-4 block font-mono uppercase tracking-widest text-white/70">KIOT - Mechanical (2023-27)</span>
                  </motion.p>
                    ...
                    <div className="flex gap-4">
                      {[
                        ...
                        <motion.a
                          ...
                          whileTap={{ scale: 0.9 }}
                          className="w-12 h-12 border border-white/10 rounded-2xl flex items-center justify-center hover:bg-white hover:text-black transition-all text-white/80"
                        >
                  ...
                  <motion.div
                    ...
                    className="flex gap-8 pt-4 border-t border-white/5 text-white/80"
                  >
                ...
                <div className="block lg:hidden mt-8 w-full max-w-sm mx-auto aspect-[4/5] rounded-[2rem] overflow-hidden border border-white/10 bg-zinc-950 shadow-2xl relative z-10 lg:col-span-5">
                  <img
              ...
              {/* Desktop hero image */}
              <div className="hidden lg:flex absolute bottom-0 right-0 w-[50%] h-[100vh] items-end justify-center z-20 pointer-events-none">
                <motion.div
                ...
                >
                  <motion.img
                    ...
                    className="w-[90%] max-w-2xl h-auto object-contain object-bottom translate-y-[15%] hover:scale-105 transition-transform duration-700 origin-center"
                    style={{
            ...
            {/* ── SECTION 2: ABOUT ── */}
            <section id="about" className={isDesktop ? "w-screen max-w-full h-screen flex items-center shrink-0 px-12 lg:px-24 relative overflow-hidden" : "w-full flex items-center relative overflow-hidden py-24 px-6 lg:px-24"}>
              <GridOverlay />
              {/* Background glow */}
              <motion.div
                initial={{ opacity: 0 }}
              ...
              <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
                  ...
                  >
                    ...
                    <div className="overflow-hidden">
                      <motion.h2
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1] }}
                        className="text-5xl md:text-7xl lg:text-[5rem] font-bold uppercase leading-none tracking-tighter"
                      >
                        Engineered <br />
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="relative aspect-[4/3] w-full max-w-2xl mx-auto mt-12 lg:mt-0"
                >
                  <motion.div
            ...
            <section id="skills" className={isDesktop ? "w-screen max-w-full h-screen flex flex-col justify-center shrink-0 px-12 lg:px-24 relative overflow-hidden" : "w-full flex flex-col justify-center relative overflow-hidden py-24 px-6 lg:px-24"}>
              <GridOverlay />
              {/* Ambient top glow */}
              <motion.div
                initial={{ opacity: 0 }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 w-full max-w-7xl mx-auto relative z-10">
                <div className="space-y-4">
                  <motion.span
                ...
                <div className="lg:col-span-2 flex flex-col sm:flex-row gap-x-24 gap-y-16">
            ...
            {/* ── SECTION 4: PROJECTS ── */}
            <section id="projects" className={isDesktop ? "min-w-fit h-screen flex items-center shrink-0 px-24 space-x-12 relative" : "w-full relative py-24 px-6 lg:px-24 flex flex-col gap-12"}>
              <GridOverlay />
              <div className={isDesktop ? "max-w-md shrink-0 space-y-8 pr-12" : "max-w-2xl space-y-6"}>
                <motion.span
                ...
                <motion.h2
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1] }}
                  className="text-6xl sm:text-7xl font-bold uppercase leading-none tracking-tighter"
                >
                  The Fleet.
                </motion.h2>
                <motion.p
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: 0.4, duration: 0.6 }}
                  className="text-sm font-mono uppercase tracking-widest leading-relaxed"
                >
              ...
              <div className={isDesktop ? "flex gap-12" : "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 w-full"}>
                {PROJECTS.map((p, i) => (
            ...
            <section id="credentials" className={isDesktop ? "w-screen max-w-full h-screen shrink-0 px-24 py-20 relative bg-black overflow-y-auto scrollbar-hide" : "w-full relative bg-black py-24 px-6 lg:px-24"}>
              <GridOverlay />

              <div className={isDesktop ? "max-w-[1700px] w-full mx-auto space-y-12 relative z-10" : "max-w-[1700px] w-full mx-auto space-y-16 relative z-10"}>
                {/* Compact Header */}
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 border-b border-white/10 pb-10">
                  <div className="space-y-4">
                    ...
                    <motion.h2
                      ...
                      whileInView={{ opacity: 1, y: 0 }}
                      viewport={{ once: true }}
                      className="text-5xl md:text-7xl lg:text-[7.5rem] font-black uppercase leading-[0.75] tracking-tighter"
                    >
                      Technical <br />
                ...
                {/* Grid layout of credentials nodes */}
                    ...
                    <div className="grid grid-cols-1 gap-6">
                      {CERTIFICATIONS.software.map((cert, i) => (
                        <motion.a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          whileHover={{ scale: 1.02, y: -4, backgroundColor: 'rgba(255,255,255,0.08)', borderColor: 'rgba(255,255,255,0.2)' }}
                        ...
                        >
                          ...
                          <div className="space-y-2 relative z-10">
                            ...
                            <h4 className="text-xl font-black uppercase tracking-tighter text-white leading-none">{cert.title}</h4>
                          </div>
                        </motion.a>
                      ))}
                    </div>
                    ...
                    <div className="space-y-4">
                      {CERTIFICATIONS.internship.map((intern, i) => (
                        <motion.a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          whileHover={{ scale: 1.01, x: 6, backgroundColor: 'rgba(255,255,255,0.06)', borderColor: 'rgba(255,255,255,0.2)' }}
                    ...
                    <div className="space-y-4">
                      {CERTIFICATIONS.electric.map((cert, i) => (
                        <motion.a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          whileHover={{ scale: 1.02, backgroundColor: 'rgba(255,255,255,0.1)', borderColor: 'rgba(255,255,255,0.3)' }}
            ...
            <section id="contact" className={isDesktop ? "w-screen max-w-full h-screen flex flex-col justify-center shrink-0 px-24 bg-white text-black rounded-l-[5rem] relative overflow-hidden" : "w-full flex flex-col justify-center bg-white text-black relative overflow-hidden py-24 px-6 lg:px-24 rounded-t-[3rem] md:rounded-t-none md:rounded-l-[5rem]"}>
              ...
              <div className="max-w-6xl w-full mx-auto space-y-20 relative z-10">
                <div className="space-y-4">
                  ...
                  <div className="overflow-hidden">
                    <motion.h2
                      ...
                      className="text-5xl sm:text-7xl md:text-[6.5rem] font-bold uppercase leading-none tracking-tighter"
                    >
                      Let's design <br />
                      <motion.span
                ...
                <motion.div
                  ...
                  className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-12 border-t border-black/10"
                >
                  <div>
        ...
        <nav className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? 'bg-black/90 backdrop-blur-xl border-b border-white/10 py-4 shadow-xl' : 'bg-transparent py-8'}`}>
          <div className="max-w-7xl mx-auto px-6 lg:px-12 flex justify-between items-center">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4, duration: 0.6 }}
              className="flex items-center gap-4 sm:gap-8 text-white animate-fade-in"
            >
              <div className={`hidden md:flex items-center gap-10 text-[11px] font-mono tracking-widest uppercase ${scrolled ? 'opacity-70' : 'opacity-85 font-bold'}`}>
                {[
              ...
              <motion.a
                ...
                className={`hidden sm:inline-block px-6 py-2 border rounded-full text-[11px] font-mono uppercase tracking-widest transition-all ${scrolled ? 'border-white/40 hover:bg-white hover:text-black' : 'border-white/20 hover:bg-white hover:text-black'}`}
              >
                Hire Me
              </motion.a>
              ...
              <button
                ...
                className={`md:hidden p-2 rounded-full border transition-all ${scrolled ? 'border-white/20 text-white' : 'border-white/20 text-white'}`}
                aria-label="Toggle Menu"
              >
                <div className="w-5 h-5 flex flex-col justify-between items-center relative py-1">
                  <span className={`w-4 h-[2px] bg-current transition-all duration-300 ${menuOpen ? 'rotate-45 translate-y-[5px]' : ''}`} />
                  <span className={`w-4 h-[2px] bg-current transition-all duration-300 ${menuOpen ? 'opacity-0' : ''}`} />
                  <span className={`w-4 h-[2px] bg-current transition-all duration-300 ${menuOpen ? '-rotate-45 -translate-y-[5px]' : ''}`} />
                </div>
              </button>
            </motion.div>
        ...
        <AnimatePresence>
          {menuOpen && (
            <motion.div
              ...
              className="fixed inset-0 z-40 bg-black/95 backdrop-blur-2xl flex flex-col justify-center items-center gap-8"
            >
              {[
                { name: 'Start', target: 'hero' },
                { name: 'Work', target: 'projects' },
                ...
                <motion.a
                  ...
                  className="text-4xl font-black uppercase tracking-widest text-white hover:text-zinc-400 transition-colors"
                >
                  {link.name}
                </motion.a>
              ))}
              ...
              <motion.a
                ...
                className="mt-4 px-8 py-3 border border-white text-white font-mono text-sm uppercase tracking-widest rounded-full hover:bg-white hover:text-black transition-all"
              >
                Hire Me
              </motion.a>
            </motion.div>
                ...
                <main ref={isDesktop ? targetRef : null} className={isDesktop ? "relative h-[600vh]" : "relative w-full bg-black"}>
          {isDesktop ? (
